...
ভেরিয়েবল হচ্ছে একটি নাম যা কম্পিউটারের একটি মেমোরি লোকেশান কে নির্দেশ করে।  উদাহরণ- 

    int cadence = 0;

একটি ভেরিয়েবল ডিক্লারেশন এর জন্যে একটি ডাটাটাইপ দরকার হয়, অর্থাৎ  ভেরিয়েবল টি কি ধরণের ডাটা হোল্ড করতে তা বলে দিতে হবে। 
উপরের উদাহরণটিতে আমরা একটি ভেরিয়েবল  ডিক্লার করেছি যার নাম cadence এবং এটি ইন্টিজার টাইপ ডাটা হোল্ড করে।

যেহেতু জাভা একটি স্ট্যাটিক্যালি টাইপড ল্যাংগুয়েজ সুতরাং  ভেরিয়েবল ডিক্লারেশন এর সময় ডাটাটাইপ উ্ল্লেখ করা অত্যাবশ্যক। 
...
এখন  bike1 এবং  bike2 তে কিছু ভেরিয়েবল গুলোও আলাদা।  অর্থাৎ আমরা যতগুলো অজেক্ট তৈরি করতেবা ঠিক ততোগুলো আলাদা ভেরিয়েবল থাকবে মেমোরিতে। এক্ষেত্রে মেমোরিতে  ২টা  cadence থাকবে, ২টা  gear থাকবে এবং  ২ speed ধাকবে। 
...
জাভা ভেরিয়েবল লেখার কিছু নিয়ম কানুন আছে-  

1. ভেরিয়েবল গুলো কেইস সেনসিটিভ। অর্থাৎ money, Money,MONEY তিনটি আলাদা। 
...
4. ভেরিয়েবল জাভার কোন reserved কিওয়ার্ড হতে পারবে না। 
...
ইকুয়ালিটি (Equality) এবং রেশনার(Relational) অপারেটর গুলো নির্ধারণ করে একটি ভ্যালু অন্যটি থেকে বড় বা ছোট কিনা। 
